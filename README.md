...
# Instructions:
This is fairly straightforward to use. Just follow the onscreen instructions and enter the link/text you want the QR code to direct to and enter your preferred filename when prompted. Make sure you remember to press the 'ENTER' key after you type into the console, for your input to be submitted and the next part of the program to run.
